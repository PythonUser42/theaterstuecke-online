...
export default function EinakterPage() {
    ...
    <main className="bg-[#ffcc00] px-4 py-6 md:px-5 md:py-10">
      <div className="mx-auto max-w-[1200px]">
        <nav className="mb-6 text-[14px] text-[#424242]">
          ...
          <span className="text-[#1a1a1a]">Einakter-Komödien</span>
        </nav>
        ...
        <div className="mb-8 rounded-[20px] bg-[#fdeaa1] px-5 py-6 md:px-10 md:py-10">
          ...
          <p className="text-[15px] leading-[1.65em] text-[#424242]">
            Kurze, pointierte Einakter-Komödien &mdash; perfekt für einen
            unterhaltsamen Theaterabend oder als Teil eines bunten Programms.
          </p>
        </div>
