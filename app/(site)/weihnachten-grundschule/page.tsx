...
export default function WeihnachtenGrundschulePage() {
  const plays = getAllPlays().filter(
    (p) => p.isChristmas && (p.ageGroups.includes("Grundschule") || p.ageGroups.includes("Kita"))
  );
      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mb-8 rounded-[20px] bg-[#fdeaa1] px-5 py-6 md:px-10 md:py-10">
          <h1 className="mb-4 font-['Amatic_SC'] text-[32px] font-bold leading-[38px] text-[#cc3333] md:text-[44px] md:leading-[48px]">
            Kurze Theaterstücke zu Weihnachten für die Grundschule
          </h1>
          <p className="text-[15px] leading-[1.65em] text-[#424242]">
            Weihnachtliche Theaterstücke für die Grundschule &mdash; lustig,
            besinnlich oder beides. Alle Stücke sind erprobt und gut spielbar.
          </p>
        </div>
