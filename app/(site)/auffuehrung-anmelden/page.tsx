...
export default function AuffuehrungAnmeldenPage() {
  return (
    <main className="bg-[#ffcc00] px-4 py-6 md:px-5 md:py-10">
      <div className="mx-auto max-w-[1200px]">
        <nav className="mb-6 text-[14px] text-[#424242]">
          ...
          <span className="text-[#1a1a1a]">Aufführung anmelden</span>
        </nav>
        ...
        <div className="rounded-[20px] bg-[#fdeaa1] px-5 py-6 md:px-10 md:py-10">
          <h1 className="mb-6 font-['Amatic_SC'] text-[32px] font-bold leading-[38px] text-[#cc3333] md:text-[44px] md:leading-[48px]">
            Anmeldung Ihrer Aufführungen
          </h1>

          <p className="mb-8 text-[15px] leading-[1.65em] text-[#424242]">
            Bitte melden Sie jede Aufführung mindestens 4 Wochen vor der Premiere an.
          </p>
          ...
          <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
            ...
            <fieldset>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-1 block text-[15px] font-bold text-[#424242]">Webseite</label>
                    <input type="url" className="w-full rounded-[8px] border border-[#e6b800] bg-white px-4 py-3 text-[15px] text-[#424242] outline-none focus:border-[#cc3333]" />
                  </div>
                </div>
              </div>
            </fieldset>
            ...
            <fieldset>
              ...
              <div className="space-y-4">
                <div>
                  <label className="mb-1 block text-[15px] font-bold text-[#424242]">Name der Spielstätte *</label>
                  <input type="text" required className="w-full rounded-[8px] border border-[#e6b800] bg-white px-4 py-3 text-[15px] text-[#424242] outline-none focus:border-[#cc3333]" />
                </div>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-1 block text-[15px] font-bold text-[#424242]">Anzahl der Zuschauerplätze *</label>
            ...
            <fieldset>
              ...
              <div className="space-y-4">
                <div>
                  <label className="mb-1 block text-[15px] font-bold text-[#424242]">Datum der Aufführungen *</label>
                  <input type="text" required placeholder="z.B. 15.03.2026, 16.03.2026" className="w-full rounded-[8px] border border-[#e6b800] bg-white px-4 py-3 text-[15px] text-[#424242] outline-none focus:border-[#cc3333]" />
                </div>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                  ...
                  <div>
                    <label className="mb-1 block text-[15px] font-bold text-[#424242]">Eintrittspreise *</label>
                    <input type="text" required placeholder="z.B. 5,00 € / 3,00 € ermäßigt" className="w-full rounded-[8px] border border-[#e6b800] bg-white px-4 py-3 text-[15px] text-[#424242] outline-none focus:border-[#cc3333]" />
                  </div>
                </div>
              </div>
            </fieldset>
